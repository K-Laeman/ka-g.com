...
const Contact = () => {
    return (
        <div className="flex flex-col md:flex-row w-full max-w-6xl mx-auto py-24">
            <div className="flex flex-col md:w-1/2 gap-4 px-6 md:px-0">
                ...
                <div className="flex flex-col py-12 w-full">
                    <div className="flex flex-col gap-4 w-full">
                        <a href="tel:+66816972220" className="flex justify-start items-center pl-4 pr-12 py-4 md:w-2/3 text-2xl font-black text-white text-start rounded-full bg-gradient-to-tr from-gray-500 to-gray-400 gap-4 hover:opacity-90 hover:scale-95 transition-all duration-500">
                        ...
                        <a
                            ...
                            target={'_blank'} rel={'noreferrer'} className="flex justify-start items-center pl-4 pr-12 py-4 md:w-2/3 text-2xl font-black text-white text-start rounded-full bg-gradient-to-tr from-green-500 to-green-400 gap-4 hover:opacity-90 hover:scale-95 transition-all duration-500">
