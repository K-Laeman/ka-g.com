...
const BoxTestPage = () => {
    return (
        <div className="flex flex-col max-w-6xl mx-auto w-full py-24">
            <div className="flex  w-full gap-12">
                <div className="w-1/2">
                    <Image src={'/assets/product/product-test.jpg'} width={500} height={375} className='w-full rounded-2xl object-contain' />
                </div>
                <div className='flex flex-col w-1/2'>
                    <h1 className='text-5xl font-bold'>{'เข็มกลัด kokotel'}</h1>
                    <span className='text-3xl font-thin text-gray-700'>{'งานสินค้าพรีเมี่ยม'}</span>
                    <div className='flex mt-12'>
                        <p className='text-2xl font-light text-gray-700'>{'รายละเอียดเกี่ยวผลงาน จำนวนสินราค้า หรือข้อมูลน่าสนใจอย่างอื่น'}</p>
                    </div>

                    <div className='flex mt-12 gap-6'>
                        <a href="" className="flex justify-start items-center pl-4 pr-12 py-4 w-1/2 text-2xl font-black text-white text-start rounded-full bg-gradient-to-tr from-green-500 to-green-400 gap-4 hover:opacity-90 hover:scale-95 transition-all duration-500">
                        ...
                        <a href="" className="flex justify-start items-center pl-4 pr-12 py-4 w-1/2 text-2xl font-black text-white text-start rounded-full bg-gradient-to-tr from-gray-500 to-gray-400 gap-4 hover:opacity-90 hover:scale-95 transition-all duration-500">
