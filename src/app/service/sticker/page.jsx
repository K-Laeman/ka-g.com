...
const tabMenu = [
    { title: 'ทั้งหมด' },
    { title: 'สติกเกอร์กลม', cat: 'cir' },
    { title: 'สติกเกอร์กาว', cat: 'glue' },
]

export default function Sticker() {
    return (
        <div className="flex flex-col w-full mt-16 py-12 md:py-24 max-w-6xl mx-auto px-6 md:px-0">
            <div className="flex flex-col gap-4 md:w-1/2">
                <h1 className="text-3xl font-bold">{'งานสติกเกอร์ม้วน'}</h1>
                <h1 className="text-xl font-medium">{'งานสติกเกอร์ม้วน งานพิมพ์ปริมาณมาก '}</h1>
            </div>
