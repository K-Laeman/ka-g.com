...
const HeroSection = () => {
    return (
        <div className="relative flex flex-col md:flex-row max-w-6xl mx-auto w-full md:h-[680px] py-8 overflow-hidden md:overflow-visible">
            <span className='absolute bottom-0 md:-top-44 -right-60  flex w-[400px] h-[400px] md:w-[800px] md:h-[800px] bg-green-200 rounded-full z-0'></span>
            <Image src={'/assets/bg/hero.png'} width={560} height={570} className='absolute  -bottom-10 -right-10 object-contain z-0 ' />
            <div className="flex flex-col w-full md:w-1/2 h-full justify-center gap-12 md:gap-12 z-10">
                <div className="flex flex-col gap-6 w-full">
                    <div className="flex flex-col w-full items-center md:items-start pt-6 md:pt-0">
                ...
                <div className="flex flex-col md:flex-row w-full items-center md:items-start md:h-24 gap-4 px-6">
                    <a
                        href="https://manager.line.biz/invitation/tofNbyb9JA4D7C3glNx3LikM6niNbQ"
                        target={'_blank'} rel={'noreferrer'}
                        className="flex justify-start items-center pl-4 pr-12 py-4 w-full md:w-1/2 text-2xl font-black text-white text-start rounded-full bg-gradient-to-tr from-green-500 to-green-400 gap-4 hover:opacity-90 hover:scale-95 transition-all duration-500">
                        <div className="flex w-14 h-14">
                            <svg id="Layer_1" data-name="Layer 1" className="fill-white w-20 rounded-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 39.92 39.89">
                    ...
                    <a href="tel:+66816972220" className="flex justify-start items-center pl-4 pr-12 py-4 w-full md:w-1/2 text-2xl font-black text-white text-start rounded-full bg-gradient-to-tr from-gray-500 to-gray-400 gap-4 hover:opacity-90 hover:scale-95 transition-all duration-500">
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-xl font-thin">
                                {'081-697-2220'}   {/* {'085-664-4692'} */}
                            </span>
                        </div>
                    </a>
                </div>
            </div>
            <div className="flex w-1/2 h-[360px] md:h-full">
